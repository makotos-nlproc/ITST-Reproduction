...
modelfile=~/ITST-Reproduction/models/waitk_st_model/EXP-001
...
output_dir=~/ITST-Reproduction/models/waitk_st_model_eval/gen
...
python fairseq_cli/sim_generate_s2t.py ${mustc_root}/en-de \
  ...
  #[--simul-type {,waitk,chunkwise,ITST,waitk_fixed_pre_decision,ITST_fixed_pre_decision,,}]